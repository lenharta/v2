...
const ICON_MAP_KEYBOARD_SHARED = {
...
const ICON_MAP_KEYBOARD_FILLED = {
  ...ICON_MAP_KEYBOARD_SHARED,
  ['keyboard-backspace']: (
    <React.Fragment>
...
const ICON_MAP_KEYBOARD_OUTLINED = {
  ...ICON_MAP_KEYBOARD_SHARED,
  ['keyboard-backspace']: (
    <React.Fragment>
  ...
  ['keyboard-capslock']: (
    <React.Fragment>
      <path d="M7.27 1.047a1 1 0 0 1 1.46 0l6.345 6.77c.6.638.146 1.683-.73 1.683H11.5v1a1 1 0 0 1-1 1h-5a1 1 0 0 1-1-1v-1H1.654C.78 9.5.326 8.455.924 7.816zM14.346 8.5 8 1.731 1.654 8.5H4.5a1 1 0 0 1 1 1v1h5v-1a1 1 0 0 1 1-1zm-9.846 5a1 1 0 0 1 1-1h5a1 1 0 0 1 1 1v1a1 1 0 0 1-1 1h-5a1 1 0 0 1-1-1zm6 0h-5v1h5z" />
    </React.Fragment>
  ),
};

export { ICON_MAP_KEYBOARD_SHARED, ICON_MAP_KEYBOARD_FILLED, ICON_MAP_KEYBOARD_OUTLINED };
