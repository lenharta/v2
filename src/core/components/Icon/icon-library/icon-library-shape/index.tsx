...
const ICON_MAP_SHAPE_FILL = {
  ...ICON_MAP_SHAPE_SHARED,
  ['shape-circle']: (
    <React.Fragment>
...
export { ICON_MAP_SHAPE_FILL, ICON_MAP_SHAPE_OUTLINE };
