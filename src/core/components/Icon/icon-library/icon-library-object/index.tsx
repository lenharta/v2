...
const ICON_MAP_OBJECT_FILL = {
  ...ICON_MAP_OBJECT_SHARED,
  ['box']: (
    <React.Fragment>
...
export { ICON_MAP_OBJECT_FILL, ICON_MAP_OBJECT_OUTLINE };
