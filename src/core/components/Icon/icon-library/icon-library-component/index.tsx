...
const ICON_MAP_COMPONENT_CHECKBOX_FILL = {
  ['checkbox-mixed-circle']: (
    <React.Fragment>
...
const ICON_MAP_COMPONENT_RADIO_OUTLINE = {
  ['radio-checked']: (
    <React.Fragment>
      <path d="M8 15A7 7 0 1 1 8 1a7 7 0 0 1 0 14m0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16" />
...
const ICON_MAP_COMPONENT_RADIO_FILL = {
  ['radio-checked']: (
    <React.Fragment>
...
const ICON_MAP_COMPONENT_THEME_MODE_OUTLINE = {
  ['mode-light']: (
    <React.Fragment>
...
const ICON_MAP_COMPONENT_THEME_MODE_FILL = {
  ['mode-light']: (
    <React.Fragment>
...
const ICON_MAP_COMPONENT_OUTLINE = {
  ...ICON_MAP_COMPONENT_SHARED,
