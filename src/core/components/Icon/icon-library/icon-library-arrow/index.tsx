...
const ICON_MAP_ARROW_OUTLINE = {
  ...ICON_MAP_ARROW_SHARED,
  ['arrow-east-square']: (
    <React.Fragment>
...
export { ICON_MAP_ARROW_OUTLINE, ICON_MAP_ARROW_FILL };
