...
export type StackTableHeadProps = {};

export type StackTableHeadFactory = Factory.Config<{
  ref: HTMLTableSectionElement;
  props: StackTableHeadProps;
  comp: 'thead';
}>;

export const StackTableHead = createFactory<StackTableHeadFactory>((props, ref) => {
